...
export const AcademicCapIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path d="M12 14l6.16-3.422A12.083 12.083 0 0121.75 8.25c0 4.967-4.033 9-9 9s-9-4.033-9-9c0-1.42.326-2.766.901-3.978L12 14z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14v7m0 0l-3-1.037V14.25l3 1.037zm0 0l3-1.037V14.25l-3 1.037z" />
    </svg>
);

export const ChatBubbleLeftRightIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.5 1.5 0 01-2.12 0l-3.72-3.72C7.347 17.1 6.5 16.136 6.5 15v-4.286c0-.97.616-1.813 1.5-2.097m6.5 0a2.25 2.25 0 01-2.25-2.25V6a2.25 2.25 0 012.25-2.25c.616 0 1.192.235 1.626.631l3.72 3.72a.75.75 0 010 1.06l-3.72 3.72a2.25 2.25 0 01-1.626.631z" />
    </svg>
);
